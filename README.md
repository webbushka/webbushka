...
Principal Software Engineer focused on React + TypeScript platforms at high scale.
I build fast, reliable user interfaces, lead frontend architecture, and mentor teams shipping production systems.

## Selected Impact

- Led a React + TypeScript platform initiative that accelerated delivery of new UI workflows and improved consistency across teams.
...
- Repositories contributed to in last 30 days: **1**
- Repositories contributed to in last 90 days: **1**
- Original vs forked repos: **72 / 67**
- Active vs archived repos: **138 / 1**
- Language mix (top 5): JavaScript (59.8%), HTML (15.9%), CSS (15.0%), TypeScript (6.5%), Python (2.8%)
- Repo footprint: **119** public repos, **20** private repos
- Public stars/followers: **159** stars, **67** followers
